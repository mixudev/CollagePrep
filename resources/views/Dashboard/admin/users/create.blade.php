    ...
    <div class="max-w-2xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            ...
            <div class="bg-white shadow-sm border border-gray-200 rounded-xl p-8">
                <form action="{{ route('admin.users.store') }}" method="POST" data-confirm-submit="Apakah Anda yakin ingin menyimpan user baru?">
                    @csrf
                    <div class="space-y-6">
                        <div>
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-4">
                            <a href="{{ route('admin.users.index') }}" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 font-medium">
                                Batal
                            </a>
