...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Modul: <span class="font-semibold">{{ $module->title }}</span></p>
                </div>
        ...
        <div class="bg-white shadow-sm border border-gray-200 rounded-xl overflow-hidden">
            <form action="{{ route('admin.questions.store') }}" method="POST" enctype="multipart/form-data" id="question-form" data-confirm-submit="Apakah Anda yakin ingin menyimpan soal baru?">
                @csrf
                
                <!-- Basic Information Section -->
                <div class="border-b border-gray-200 bg-gray-50 px-6 py-4">
                    <h2 class="text-base font-semibold text-gray-900">Informasi Dasar</h2>
                    <p class="text-xs text-gray-600 mt-1">Modul dan kategori sudah ditentukan</p>
                </div>
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="category_id" value="{{ $module->category_id }}">
                            <div class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-700 cursor-not-allowed">
                    ...
                    <div>
                        ...
                        <textarea name="question_text" rows="5" required 
                            ...
                            placeholder="Masukkan teks soal di sini...">{{ old('question_text') }}</textarea>
                        @error('question_text')
                ...
                <div class="border-t border-gray-200 bg-gray-50 px-6 py-4">
                    <h2 class="text-base font-semibold text-gray-900">Pengaturan Soal</h2>
                    <p class="text-xs text-gray-600 mt-1">Konfigurasi tipe, kesulitan, dan poin soal</p>
                </div>
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="points" value="{{ old('points', 1) }}" required min="0" step="0.1" 
                ...
                <div id="options-section" class="border-t border-gray-200 hidden">
                    <div class="bg-gray-50 px-6 py-4">
                        <h2 class="text-base font-semibold text-gray-900">Pilihan Jawaban</h2>
                        <p class="text-xs text-gray-600 mt-1">Tambahkan pilihan jawaban dan tandai jawaban yang benar</p>
                    </div>
                    
                    <div class="p-6">
                        <div id="options-container" class="space-y-4">
                            @for($i = 0; $i < 5; $i++)
                                <div class="option-item flex items-start gap-4 p-4 border-2 border-gray-200 rounded-lg hover:border-gray-400 transition-colors bg-white">
                                    <div class="flex-shrink-0">
                                        <div class="w-12 h-12 flex items-center justify-center bg-gray-100 text-gray-700 rounded-lg font-bold text-lg">
                                            {{ chr(65 + $i) }}
                                        </div>
                                    </div>
                                    <div class="flex-1">
                ...
                <div id="true-false-section" class="border-t border-gray-200 hidden">
                    <div class="bg-gray-50 px-6 py-4">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <label class="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:border-gray-400 transition-colors cursor-pointer bg-white">
                                <input type="radio" name="true_false_answer" value="true" 
                                    class="h-5 w-5 text-gray-900 focus:ring-gray-500"
                                    {{ old('true_false_answer') == 'true' ? 'checked' : '' }}>
                                <div class="ml-4">
                            ...
                            <label class="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:border-gray-400 transition-colors cursor-pointer bg-white">
                                <input type="radio" name="true_false_answer" value="false" 
                                    class="h-5 w-5 text-gray-900 focus:ring-gray-500"
                                    {{ old('true_false_answer') == 'false' ? 'checked' : '' }}>
                                <div class="ml-4">
                ...
                <div class="border-t border-gray-200 bg-gray-50 px-6 py-4">
                    <h2 class="text-base font-semibold text-gray-900">Informasi Tambahan</h2>
                    <p class="text-xs text-gray-600 mt-1">Tambahkan pembahasan dan pengaturan lainnya</p>
                </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="explanation" rows="4" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors resize-none"
                            placeholder="Masukkan pembahasan atau penjelasan untuk jawaban yang benar...">{{ old('explanation') }}</textarea>
                        @error('explanation')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
